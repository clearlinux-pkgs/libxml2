...
BuildRequires : pkgconfig(32history)
BuildRequires : pkgconfig(32icu-uc)
BuildRequires : pkgconfig(32readline)
...
%prep
%setup -q -n libxml2-2.14.2
cd %{_builddir}
tar xf %{_sourcedir}/libxml2-profile-1.tar.bz2
cd %{_builddir}/libxml2-2.14.2
mkdir -p ../libxml2-profile
cp -r %{_builddir}/libxml2-profile-1/. %{_builddir}/libxml2-2.14.2/../libxml2-profile
%patch -P 1 -p1
pushd ..
cp -a libxml2-2.14.2 build32
popd
pushd ..
cp -a libxml2-2.14.2 buildavx2
popd
...
perl ../libxml2-profile/dbgenattr.pl 100000 > dba100000.xml
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxml2.so.16.0.2
/usr/lib64/libxml2.so.16
/usr/lib64/libxml2.so.16.0.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libxml2.so.16
/usr/lib32/libxml2.so.16.0.2
