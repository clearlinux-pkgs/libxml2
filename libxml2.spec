...
Source0  : https://download.gnome.org/sources/libxml2/2.13/libxml2-2.13.3.tar.xz
...
%prep
%setup -q -n libxml2-2.13.3
cd %{_builddir}/libxml2-2.13.3
%patch -P 1 -p1
pushd ..
cp -a libxml2-2.13.3 build32
popd
pushd ..
cp -a libxml2-2.13.3 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxml2.so.2.13.3
/usr/lib64/libxml2.so.2
/usr/lib64/libxml2.so.2.13.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libxml2.so.2
/usr/lib32/libxml2.so.2.13.3
