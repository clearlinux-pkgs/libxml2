...
Source0  : https://gitlab.gnome.org/GNOME/libxml2/-/archive/v2.13.2/libxml2-v2.13.2.tar.gz
...
%prep
%setup -q -n libxml2-v2.13.2
cd %{_builddir}/libxml2-v2.13.2
%patch -P 1 -p1
pushd ..
cp -a libxml2-v2.13.2 build32
popd
pushd ..
cp -a libxml2-v2.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720133382
...
cp %{_builddir}/libxml2-v%{version}/Copyright %{buildroot}/usr/share/package-licenses/libxml2/8b8a61fcd505743acbe94866f4f73b2fdf1f359f || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxml2.so.2.13.2
/usr/lib64/libxml2.so.2
/usr/lib64/libxml2.so.2.13.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libxml2.so.2
/usr/lib32/libxml2.so.2.13.2
