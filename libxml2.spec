...
%prep
%setup -q -n libxml2-2.13.4
cd %{_builddir}/libxml2-2.13.4
%patch -P 1 -p1
pushd ..
cp -a libxml2-2.13.4 build32
popd
pushd ..
cp -a libxml2-2.13.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730087406
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxml2.so.2.13.4
/usr/lib64/libxml2.so.2
/usr/lib64/libxml2.so.2.13.4

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libxml2.so.2
/usr/lib32/libxml2.so.2.13.4
