...
Version  : 2.11.8
Release  : 121
URL      : https://gitlab.gnome.org/GNOME/libxml2/-/archive/v2.11.8/libxml2-v2.11.8.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/libxml2/-/archive/v2.11.8/libxml2-v2.11.8.tar.gz
...
%prep
%setup -q -n libxml2-v2.11.8
cd %{_builddir}/libxml2-v2.11.8
%patch -P 1 -p1
pushd ..
cp -a libxml2-v2.11.8 build32
popd
pushd ..
cp -a libxml2-v2.11.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715626970
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxml2.so.2.11.8
/usr/lib64/libxml2.so.2
/usr/lib64/libxml2.so.2.11.8

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libxml2.so.2
/usr/lib32/libxml2.so.2.11.8
