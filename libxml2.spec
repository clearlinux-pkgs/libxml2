...
Source0  : https://download.gnome.org/sources/libxml2/2.14/libxml2-2.14.4.tar.xz
...
%prep
%setup -q -n libxml2-2.14.4
cd %{_builddir}
tar xf %{_sourcedir}/libxml2-profile-1.tar.bz2
cd %{_builddir}/libxml2-2.14.4
mkdir -p ../libxml2-profile
cp -r %{_builddir}/libxml2-profile-1/. %{_builddir}/libxml2-2.14.4/../libxml2-profile
%patch -P 1 -p1
pushd ..
cp -a libxml2-2.14.4 build32
popd
pushd ..
cp -a libxml2-2.14.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750261374
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxml2.so.16.0.4
/usr/lib64/libxml2.so.16
/usr/lib64/libxml2.so.16.0.4
