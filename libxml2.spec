...
Source0  : https://gitlab.gnome.org/GNOME/libxml2/-/archive/v2.9.13/libxml2-v2.9.13.tar.gz
...
%prep
%setup -q -n libxml2-v2.9.13
cd %{_builddir}/libxml2-v2.9.13
%patch1 -p1
pushd ..
cp -a libxml2-v2.9.13 build32
popd
pushd ..
cp -a libxml2-v2.9.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645560066
...
cp %{_builddir}/libxml2-v2.9.13/Copyright %{buildroot}/usr/share/package-licenses/libxml2/3c21506a45e8d0171fc92fd4ff6903c13adde660
pushd ../build32/
%make_install32
